    ...
    return (
        <View style={{height: '100%'}}>
            <Image
                ...
                style={{width: '100%', height: '40%', maxHeight: 250}}
            />
            <FloatingButton
                icon="chevron-left"
            ...
            />
            <View style={{paddingHorizontal: 20, backgroundColor: AppColor.background}}>
            <TextSubTitle
                title={
                    station.properties.isPublic
            ...
            <ScrollView showsVerticalScrollIndicator={false} style={{backgroundColor: AppColor.background}}>
                <View
                    style={{
                        height: height,
